...
|------|---------|--------------|---------|--------|
| index.html | 1.0 | 2026-05-22 | All game screens | Active |
| style.css | 1.0 | 2026-05-22 | Styling | Active |
| game.js | 1.4 | 2026-05-22 | Game logic. Phase 1 WIP — steps 1.1-1.4 done: loads age-appropriate question file; gym questions drawn from blueprint+bank; pre-game + regional catch flows wired to banks; pokemon.json loaded for starters + regional with race-rule greyout. Step 1.5 (110-ability runtime + level-up + crystal-to-peso) is next | Active |
...
| CLAUDE.md | 0.2.0 | 2026-05-22 | Master project doc — Phase Zero complete + multi-machine git workflow | Active |
| FILES.md | 1.8 | 2026-05-22 | This manifest | Active |
