...
| game.js | 1.6 | 2026-05-22 | Game logic. Phase 1 complete (steps 1.1-1.6): age-routed question file load; gym questions drawn from blueprint+bank with random per-kid picks; pre-game + regional catch flows wired to banks; pokemon.json loaded for starters + regional with race-rule greyout; useAbility now a generic dispatcher for all 10 mechanics; engine test gated to Regions 1-2 with defensive guards | Active |
...
| FILES.md | 1.9 | 2026-05-22 | This manifest | Active |
