...
| FILES.md | 1.35 | 2026-05-25 | This manifest. v1.35: battle engine Commit 3 — game.js v1.20 (6 battle abilities + Legendary gate + reminders), index.html v1.8.5 (ability bar + dead controls removed), style.css v1.7.5 (ability bar + gate styles). v1.34: battle engine Commit 2 — game.js v1.19 (full battle loop + host panel), index.html v1.8.4 (col3-battle-panel div), style.css v1.7.4 (host battle styles). v1.33: battle engine Commit 1 scaffold. v1.32: SPEC v3.7, pokemon.json v2.2, BACKLOG.md v1.1, CLAUDE.md sync note. | Active |
